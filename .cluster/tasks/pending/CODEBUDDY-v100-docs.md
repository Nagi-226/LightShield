# CODEBUDDY-v100-docs：v1.0.0 正式版文档全套
...
LightShield 轻盾 — 开源轻量化安全自检 + 防御加固工具，基于 Python 3.10+ / MIT 协议。当前 v0.0.46（991 tests / 覆盖率 82.72% / 0C/0H/0M），目标是 v1.0.0 正式版发布。

v1.0.0 意味着项目向公众正式开放、接受外部贡献、可能发布到 PyPI。文档必须达到开源社区标配水平。
...
| **CODE_OF_CONDUCT.md** | v1.0.0 接受外部贡献的先决条件 | 采用 Contributor Covenant 2.1 标准模板 + LightShield 社群特定规则（不接受攻击代码相关 PR） |
